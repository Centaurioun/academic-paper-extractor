...
export const HourglassIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5 22h14"/>
        <path d="M5 2h14"/>
        <path d="M17 2v2.34c0 .55-.22 1.07-.62 1.45L12 10l-4.38-4.21A2.07 2.07 0 0 1 7 4.34V2"/>
        <path d="M7 22v-2.34c0-.55.22-1.07.62-1.45L12 14l4.38 4.21c.4.38.62.9.62 1.45V22"/>
    </svg>
);
